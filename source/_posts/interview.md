...
我的技术栈是react+vue 主要负责社内私有云平台(cloudjump、storagejump、fone hci)的中后台管理系统的开发，之前主要做的是华为odc的外派工作，主要
做dds文档数据库、geminidb多模nosql数据库console控制台系统的开发维护
...
前端，更加贴近用户，能够从不同的角度看问题和需求。~ 有输入就要有输出。
